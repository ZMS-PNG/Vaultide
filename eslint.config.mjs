...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    // Obsidian plugin build output and workspace-linked dependencies are not
    // authored source. The plugin's TypeScript source is linted normally.
    ...
    'e2e/**',
    // Locally generated smoke artifacts are executed by their owning scripts;
    // they are not application source and must never affect release lint.
    'tmp/**',
