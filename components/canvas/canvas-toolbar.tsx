      ...
      <div className="flex items-center gap-1 shrink-0 pl-1">
        {onToggleSidebar && (
          <button
            ...
            aria-label={sidebarCollapsed ? '展开场景列表' : '收起场景列表'}
            title={sidebarCollapsed ? '展开场景列表' : '收起场景列表'}
          >
        ...
        <span
          ...
          aria-label={`当前场景 ${currentSceneIndex + 1}，共 ${scenesCount} 个场景`}
        >
        ...
        >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    aria-label={`播放速度 ${playbackSpeed} 倍`}
                  >
          ...
          {showStopDiscussion && onStopDiscussion ? (
            ...
            <button
              ...
              aria-label={engineState === 'playing' ? '暂停播放' : '开始播放'}
            >
              {engineState === 'playing' ? (
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    aria-label={autoPlayLecture ? '关闭自动播放' : '开启自动播放'}
                  >
          ...
          <button
            ...
            className={cn(
              ctrlBtn,
              'w-auto h-6 gap-1 px-1.5 sm:px-2',
              whiteboardOpen
                ? 'text-violet-600 dark:text-violet-400'
                : 'text-gray-500 dark:text-gray-400',
            )}
            aria-label={whiteboardOpen ? '收起白板' : '打开白板'}
            title={whiteboardOpen ? t('whiteboard.minimize') : t('whiteboard.open')}
          >
            <PencilLine className="w-3.5 h-3.5" />
            <span className="hidden text-[11px] font-medium sm:inline">白板</span>
      ...
      <div className="flex items-center justify-end gap-px shrink-0 pr-1">
        ...
        {onToggleChat && (
          <button
            ...
            aria-label={chatCollapsed ? '展开课堂对话' : '收起课堂对话'}
            title={chatCollapsed ? '展开课堂对话' : '收起课堂对话'}
          >
