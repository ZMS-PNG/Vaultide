...
const EMPTY_HOST_RECT: LayoutRect = { left: 0, top: 0, width: 0, height: 0 };
...
function PBLV2WorkspaceLayer({
  ...
  const [hostRect, setHostRect] = useState<LayoutRect>(EMPTY_HOST_RECT);
  ...
  const animateFrame = expanded || autoExpand;
