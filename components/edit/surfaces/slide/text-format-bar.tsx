...
function FontSizeInput({
  ...
  return (
    <input
      ...
      aria-label={label}
      value={sizeInput}
      onChange={(event) => setSizeInput(event.target.value.replace(/\D/g, ''))}
      onBlur={commitSize}
      onKeyDown={(event) => {
