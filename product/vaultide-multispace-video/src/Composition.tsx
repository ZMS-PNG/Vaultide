		...
		<Scene duration={DURATIONS[0]} background={colors.navy}>
			...
			>
				...
				<div style={{maxWidth: 1280}}>
					<Reveal delay={4}>
						<Kicker light>真正的难题，不是资料不够</Kicker>
					</Reveal>
					<div
						style={{
							marginTop: 30,
			...
			>
				...
				>
					<div style={{display: 'flex', flexDirection: 'column', gap: 18}}>
						<Kicker color={colors.blue}>01 · 学习外部新知识</Kicker>
		...
		>
			...
			>
				<div style={{display: 'flex', flexDirection: 'column', gap: 16}}>
					<Kicker>02 · 学习 Obsidian 内部内容</Kicker>
		...
		<Scene duration={DURATIONS[4]}>
			...
			>
				<div style={{display: 'flex', flexDirection: 'column', gap: 26}}>
					<Kicker color={colors.green}>03 · 真正形成掌握证据</Kicker>
	...
	return (
		<Scene duration={DURATIONS[5]} background="#F7F4FF">
			...
			>
				...
				>
					<div style={{display: 'flex', flexDirection: 'column', gap: 16}}>
						<Kicker>04 · 安全沉淀到 Obsidian</Kicker>
						<div style={{fontSize: 72, lineHeight: 1.06, fontWeight: 900}}>
							网页先预览，本地最终确认
						</div>
					</div>
	...
	return (
		<Scene duration={DURATIONS[6]} background={colors.navy}>
			...
			>
				...
				>
					<div>
						<Kicker light>05 · 问题驱动归纳 + 多维逻辑解释</Kicker>
...
const VaultideLearningLoop: React.FC = () => (
...
export const VaultideComposition: React.FC = () => (
	<Composition
		id="VaultideLearningLoopHumanVoice2026"
		component={VaultideLearningLoop}
